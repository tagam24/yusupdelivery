        ...
        get_data=new Thread(new Runnable() {
            ...
            public void run() {
                try{
                    ...
                    URL url=new URL("http://"+Api.url+"tagam24/search_cafe_bar.php");
                    Log.d("url",""+url);
                ...
                try{//bashda data basadan hemme informasiyasyny alyas
                    ...
                    for(int i=0; i<jsonArray.length();i++) {
                       ...
                       /* Constants.cafe.add(new Model_Cafe(data.optString("id"),data.optString("image"),
                                ...
                                data.optString("rating"),
                                data.optString("workstat"),data.optString("logo"),data.optString("dostawka_price")));*/
                    }
