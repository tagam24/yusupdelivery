...
public class send_team {
   public  static String k;
    public  static int con=0;
    static String l;
    public static   Thread get_data=new Thread();
    public static void  get_Data(final String id,final String wins,final String table){
            Log.d("gelenok","ok");
        get_data=new Thread(new Runnable() {
            ...
            public void run() {
                try{
                    ...
                    URL url=new URL("http://"+Api.url+"tagam24/send_team.php");
                    Log.d("url",""+url);
                    ...
                    String post_data =  URLEncoder.encode("id", "UTF-8") + "=" + URLEncoder.encode(id, "UTF-8")
                            +"&"+ URLEncoder.encode("wins", "UTF-8") + "=" + URLEncoder.encode(wins, "UTF-8")
