...
public class RecycleAdapter_recipe_tayarlansy extends RecyclerView.Adapter<RecycleAdapter_recipe_tayarlansy.Reklama_viewholder> {
    String[] list1;
    Context cntx;
    String table;
    ...
    public class Reklama_viewholder extends RecyclerView.ViewHolder {
        ...
        public Reklama_viewholder(View itemView) {
            ...
            number= (TextView) itemView.findViewById(R.id.number_card_duzumi);


        }
    }

    public RecycleAdapter_recipe_tayarlansy(String[] items, Context ctx) {
        this.list1 = items;
        this.cntx = ctx;
    }
    ...
    public Reklama_viewholder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.card_recipe_make, parent, false);
